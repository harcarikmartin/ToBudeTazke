...
<body>
  		...
  		<div class = "row">
			...
			<div class="col-sm-8 col-md-6 col-lg-6">
				<h1><a href="/GS_Harcarik"><c:if test="${player.playerName != null}">${player.playerName}, w</c:if><c:if test="${player.playerName == null}">W</c:if>elcome to Gamestudio</a></h1></div>
	...
	<div class="row">
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				<a href="/GS_Harcarik/Studiostats">Gamestudio statistics</a>
			</div>
			<div class="col-sm-3 col-md-4 col-lg-4"></div>
		</div>
