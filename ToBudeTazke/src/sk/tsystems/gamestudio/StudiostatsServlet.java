...
//	List<GameCountScores> gameCountScores = 
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("mostActivePlayer", JpaHelper.getEntityManager().createQuery("Select max(s.player.playerName) from "
				+ "Score s group by s.player").getResultList().toString());
